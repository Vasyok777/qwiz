	...
	return (
		<main className='grid min-h-screen grid-cols-2 lg:grid-cols-1 gap-10 lg:gap-5 items-center justify-between px-24 py-10 relative 2xl:px-10 md:gap-0'>
			...
			<div>
				...
				<h1 className='mb-4 lg:mb-[12px] relative'>Менеджер з продажів</h1>
				<p className='max-w-[682px] mb-10 md:text-[14px] md:mb-4'>
					Ви вмієте спілкуватися, переконувати та досягати результатів. Ваші
					аналітичні здібності та орієнтація на цілі допоможуть вам бути
					успішним у продажах
				</p>
				<Image
					src={'/two.png'}
